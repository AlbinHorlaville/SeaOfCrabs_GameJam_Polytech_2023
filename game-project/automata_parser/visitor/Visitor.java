...
import automate.Conjonction;
import automate.Disjunction;
...
public class Visitor implements IVisitor {
	...
	public Object exit(Condition condition, Object expression) {
		// TODO Auto-generated method stub
		// System.out.println("I enter condition with expression "+
		// condition.toString());
		return expression;
	}
	...
	public Object visit(Transition transition, Object condition, Object action, Object target_state) {
		// TODO Auto-generated method stub
		// System.out.println("Im in transition condition action target_state "+
		// transition.toString());
		automate.Condition c = new automate.Condition((automate.FunCall) condition);
		return new automate.Transition(c, (automate.Action) action, (automate.State) target_state);
	}
	...
	public Object exit(Automaton automaton, Object initial_state, List<Object> modes) {
		...
		// System.out.println("================Bienvenue dans le debuggage
		// d'automate================");
		// a.print();
		return a;
	}
