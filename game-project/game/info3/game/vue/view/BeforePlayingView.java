...
public class BeforePlayingView extends View {
	...
	public BeforePlayingView(GameView gv) {
		...
		boxSwordPlayer1 = new UIBox(96, Weapon.Sword, new UIImage(0, 0, "resources/img/Sword.png", 2F));
		boxScythePlayer1 = new UIBox(96, Weapon.Scythe, new UIImage(0, 0, "resources/img/Scythe.png", 2F));
		boxSwordPlayer2 = new UIBox(96, Weapon.Sword, new UIImage(0, 0, "resources/img/Sword.png", 2F));
		boxScythePlayer2 = new UIBox(96, Weapon.Scythe, new UIImage(0, 0, "resources/img/Scythe.png", 2F));
