...
public abstract class Entity {
	...
	public boolean checkCollision(EnumDirection direction, int speed) {
		...
		for (Entity e : GameModele.entities) {
			...
			int distanceBetweenIandE = (int) java.lang.Math
					.sqrt(java.lang.Math.pow(X - e.x, 2) + java.lang.Math.pow(Y - e.y, 2)) - r - e.r;
	...
	/*
	 * D�placement de l'entit� en coordon�e absolue L'impl�mentation initial
	 * est pour le d�placement du joueur sur terre
	 */
	...
	/*
	 * D�placement de l'entit� en coordon�e relatif L'impl�mentation initial
	 * est pour le d�placement du joueur sur terre
	 */
